...
REM Smart Helmet Mapper - CORRECTED COORDINATES
...
REM FIXED: Y coordinates now stay within 462px image height
...
echo 🏈 Smart Helmet Mapper - CORRECTED COORDINATES
...
REM FIXED: Y coordinates adjusted to fit within 462px height

echo 🔍 Attempting common NFL helmet sheet layout with corrected coordinates...
echo.

REM Row 1: AFC East and NFC East (Y: 0-140)
...
REM Row 2: AFC North and NFC North (Y: 160-300)
echo.
...
REM Row 3: AFC South and NFC South (Y: 320-462)
echo.
...
REM Row 4: AFC West and NFC West (Y: 0-140, second pass)
echo.
...
magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+860+0 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\sf-helmet.png"
magick "%OUTPUT_DIR%\sf-helmet.png" -flop "%OUTPUT_DIR%\sf-helmet-flipped.png"
echo ✅ Created sf-helmet.png (49ers - NFC West)

REM Row 5: Remaining teams (Y: 160-300, second pass)
echo.
...
magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+860+160 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\no-helmet.png"
...
magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+860+320 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\chi-helmet.png"
...
echo.
echo 🎉 Smart helmet mapping with corrected coordinates complete!
...
echo ✅ FIXED: Y coordinates now stay within 462px image height
