...
REM Smart Helmet Mapper - FINAL VERSION
...
REM FIXED: Both X and Y coordinates now stay within image boundaries
...
echo 🏈 Smart Helmet Mapper - FINAL VERSION
...
REM FIXED: Both X and Y coordinates adjusted to fit within image boundaries

echo 🔍 Attempting common NFL helmet sheet layout with final coordinate fixes...
echo.

REM Row 1: AFC East and NFC East (Y: 0-140, X: 0-660)
...
magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+660+0 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\phi-helmet.png"
magick "%OUTPUT_DIR%\phi-helmet.png" -flop "%OUTPUT_DIR%\phi-helmet-flipped.png"
echo ✅ Created phi-helmet.png (Eagles - NFC East)

REM Row 2: AFC North and NFC North (Y: 160-300, X: 0-660)
echo.
...
magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+660+160 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\det-helmet.png"
magick "%OUTPUT_DIR%\det-helmet.png" -flop "%OUTPUT_DIR%\det-helmet-flipped.png"
echo ✅ Created det-helmet.png (Lions - NFC North)

REM Row 3: AFC South and NFC South (Y: 320-462, X: 0-660)
echo.
...
magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+660+320 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\atl-helmet.png"
magick "%OUTPUT_DIR%\atl-helmet.png" -flop "%OUTPUT_DIR%\atl-helmet-flipped.png"
echo ✅ Created atl-helmet.png (Falcons - NFC South)

REM Row 4: AFC West and NFC West (Y: 0-140, second pass, X: 0-660)
echo.
echo Processing Row 4: AFC West and NFC West
magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+0+0 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\den-helmet.png"
magick "%OUTPUT_DIR%\den-helmet.png" -flop "%OUTPUT_DIR%\den-helmet-flipped.png"
echo ✅ Created den-helmet.png (Broncos - AFC West)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+230+0 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\kc-helmet.png"
magick "%OUTPUT_DIR%\kc-helmet.png" -flop "%OUTPUT_DIR%\kc-helmet-flipped.png"
echo ✅ Created kc-helmet.png (Chiefs - AFC West)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+460+0 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\lac-helmet.png"
magick "%OUTPUT_DIR%\lac-helmet.png" -flop "%OUTPUT_DIR%\lac-helmet-flipped.png"
echo ✅ Created lac-helmet.png (Chargers - AFC West)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+630+0 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\lar-helmet.png"
magick "%OUTPUT_DIR%\lar-helmet.png" -flop "%OUTPUT_DIR%\lar-helmet-flipped.png"
echo ✅ Created lar-helmet.png (Rams - NFC West)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+660+0 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\sf-helmet.png"
magick "%OUTPUT_DIR%\sf-helmet.png" -flop "%OUTPUT_DIR%\sf-helmet-flipped.png"
echo ✅ Created sf-helmet.png (49ers - NFC West)

REM Row 5: Remaining teams (Y: 160-300, second pass, X: 0-660)
echo.
echo Processing Row 5: Remaining teams
magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+0+160 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\lv-helmet.png"
magick "%OUTPUT_DIR%\lv-helmet.png" -flop "%OUTPUT_DIR%\lv-helmet-flipped.png"
echo ✅ Created lv-helmet.png (Raiders - AFC West)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+230+160 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\pit-helmet.png"
magick "%OUTPUT_DIR%\pit-helmet.png" -flop "%OUTPUT_DIR%\pit-helmet-flipped.png"
echo ✅ Created pit-helmet.png (Steelers - AFC North)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+460+160 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\ten-helmet.png"
magick "%OUTPUT_DIR%\ten-helmet.png" -flop "%OUTPUT_DIR%\ten-helmet-flipped.png"
echo ✅ Created ten-helmet.png (Titans - AFC South)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+630+160 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\ari-helmet.png"
magick "%OUTPUT_DIR%\ari-helmet.png" -flop "%OUTPUT_DIR%\ari-helmet-flipped.png"
echo ✅ Created ari-helmet.png (Cardinals - NFC West)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+660+160 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\no-helmet.png"
magick "%OUTPUT_DIR%\no-helmet.png" -flop "%OUTPUT_DIR%\no-helmet-flipped.png"
echo ✅ Created no-helmet.png (Saints - NFC South)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+0+320 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\nyj-helmet.png"
magick "%OUTPUT_DIR%\nyj-helmet.png" -flop "%OUTPUT_DIR%\nyj-helmet-flipped.png"
echo ✅ Created nyj-helmet.png (Jets - AFC East)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+230+320 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\min-helmet.png"
magick "%OUTPUT_DIR%\min-helmet.png" -flop "%OUTPUT_DIR%\min-helmet-flipped.png"
echo ✅ Created min-helmet.png (Vikings - NFC North)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+460+320 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\was-helmet.png"
magick "%OUTPUT_DIR%\was-helmet.png" -flop "%OUTPUT_DIR%\was-helmet-flipped.png"
echo ✅ Created was-helmet.png (Commanders - NFC East)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+630+320 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\nyg-helmet.png"
magick "%OUTPUT_DIR%\nyg-helmet.png" -flop "%OUTPUT_DIR%\nyg-helmet-flipped.png"
echo ✅ Created nyg-helmet.png (Giants - NFC East)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+660+320 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\chi-helmet.png"
magick "%OUTPUT_DIR%\chi-helmet.png" -flop "%OUTPUT_DIR%\chi-helmet-flipped.png"
echo ✅ Created chi-helmet.png (Bears - NFC North)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+0+0 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\car-helmet.png"
magick "%OUTPUT_DIR%\car-helmet.png" -flop "%OUTPUT_DIR%\car-helmet-flipped.png"
echo ✅ Created car-helmet.png (Panthers - NFC South)

magick "%INPUT_FILE%" -crop %HELMET_WIDTH%x%HELMET_HEIGHT%+230+0 -trim +repage -background transparent -gravity center -extent %HELMET_SIZE% "%OUTPUT_DIR%\sea-helmet.png"
magick "%OUTPUT_DIR%\sea-helmet.png" -flop "%OUTPUT_DIR%\sea-helmet-flipped.png"
echo ✅ Created sea-helmet.png (Seahawks - NFC West)

echo.
echo 🎉 Smart helmet mapping with final coordinate fixes complete!
...
echo ✅ FIXED: Both X and Y coordinates now stay within image boundaries
echo ✅ FIXED: X coordinates limited to 660px (860-200 crop width)
