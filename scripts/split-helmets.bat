...
REM NFL Helmet Sheet Splitter (Windows Batch Version)
...
REM Estimated crop dimensions based on description
set HELMET_WIDTH=280
set HELMET_HEIGHT=230
set H_SPACING=60
set V_SPACING=30
set LEFT_SECTION_WIDTH=1000
set CENTRAL_GAP=350
